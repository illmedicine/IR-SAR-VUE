...
scenarios = [
    # F: LFM, mBP, 100km alt, 10 sec CPI
    {
        ...
        "tdbp": {
            ...
            "z_focus": 100000.0, "v_tgt": [3430.0, 0.0, 0.0], "center_mode": "track"
        }
    },
    # F2: OFDM, Spotlight, Closeup => 2s
    {
        "name": "F2_Warhead_Closeup",
        "processor": "spotlight",
        "cfg": {
            "waveform_type": "LFM", "bandwidth_hz": 500e6,
            "sar_mode": "spotlight", 
            "tx_power_w": 20000.0, "cpi_sec": 2.0,
            "num_warheads": 1, "warhead_alt_m": 100000.0, "warhead_vel_m_s": [3430.0, 0.0, 0.0],
            "num_clutter_pts": 0, "num_cars": 0, "num_people_only": 0, "num_inband_emitters": 0,
            "area_size_m": [50, 50], "earth_rotation_mode": "none"
        },
        "tdbp": {
            "scene_size": 100.0, "nx": 512, "ny": 512,
            "z_focus": 100000.0, "v_tgt": [3430.0, 0.0, 0.0], "center_mode": "track",
            "enable_video": True, "video_cpi": 0.5, "video_fps": 5, "video_duration": 2.0
        }
    }
]
